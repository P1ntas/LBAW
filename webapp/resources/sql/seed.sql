...
-- pass: 123aaa
INSERT INTO users VALUES (DEFAULT, 'Afonso Abreu', 'afonsoabreu@gmail.com', '$2y$10$zDj6a4T6jh3cWsXtqTTA1OsGuZGTTXOnSaoCgfg3vFxYgOXPUJP.u', '696 Magna. Street', '935235731', DEFAULT, DEFAULT);

-- pass: 456bbb
INSERT INTO users VALUES (DEFAULT, 'Afonso Pinto', 'afonsopinto@gmail.com', '$2y$10$3vNl7O0h/zyiPDLx8K6PnOqlMt/x5/QeqvsQLwr.P6DLNcIUocZD2', '696 Magna. Street', '935235731', DEFAULT, DEFAULT);

-- pass: 789ccc
INSERT INTO users VALUES (DEFAULT, 'Ruben Monteiro', 'rubenmonteiro@gmail.com', '$2y$10$8EcFsTtcNOVWoDHpPwh1XuCwuuEMZLuTP4kiGu3oykxFc2kWT6hdi', '696 Magna. Street', '935235731', DEFAULT, DEFAULT);

-- pass: qwerty33
INSERT INTO users VALUES (DEFAULT, 'Diogo Silva', 'diogosilva@gmail.com', '$2y$10$GukHc3Ue3yKDiUXJXHCbyOkV4.aX4fxbVgV2v0XUOHv0nw/OyZzbS', '696 Magna. Street', '987654321', DEFAULT, TRUE);
...
INSERT INTO book VALUES 
  ...
  (DEFAULT, 'Moby-Dick', '0451524934', 1851, 16.99, 20, 7, 'The tale of Captain Ahabs obsession with hunting the white whale, Moby Dick.', 5, 3),
  ...
  (DEFAULT, 'The Handmaids Tale', '038549081', 1985, 14.99, 30, 22, 'A dystopian novel set in a future society where women have no rights and are used solely for reproductive purposes.', 1, 3),
  ...
  (DEFAULT, 'The Help', '042523220', 2009, 8.99, 60, 32, 'The story of three women in 1960s Mississippi, including Aibileen, a black maid, and Skeeter, a white woman, who team up to write a book about the experiences of black maids in the South.', 6, 3),
...
INSERT INTO collections VALUES (DEFAULT, 'Winter Collection');
INSERT INTO book_collection VALUES (20, 2);
INSERT INTO book_collection VALUES (21, 2);
INSERT INTO book_collection VALUES (22, 2);

INSERT INTO collections VALUES (DEFAULT, 'Secret Collection');
INSERT INTO book_collection VALUES (10, 3);
INSERT INTO book_collection VALUES (11, 3);
INSERT INTO book_collection VALUES (12, 3);

INSERT INTO collections VALUES (DEFAULT, 'Odd Collection');
INSERT INTO book_collection VALUES (4, 4);
INSERT INTO book_collection VALUES (5, 4);
INSERT INTO book_collection VALUES (6, 4);
...
INSERT INTO review VALUES 
  (DEFAULT, 5, 'I really enjoyed this book! The characters were well-developed and the plot kept me engaged throughout.', '2022-01-01', 1, 1),
  (DEFAULT, 4, 'This book was amazing! I couldnt put it down. The writing was beautiful and the story was so moving.', '2022-01-02', 2, 2),
  (DEFAULT, 3, 'It was a good book, but I felt like the ending was a bit rushed. Overall, I would recommend it.', '2022-01-03', 3, 3),
  (DEFAULT, 5, 'I loved the world-building in this book. The characters were a bit flat, but the plot kept me interested.', '2022-01-04', 4, 4),
  (DEFAULT, 4, 'This was one of the best books Ive ever read. The writing was beautiful and the story was so compelling. I cant wait to read more from this author.', '2022-01-05', 5, 1),
  (DEFAULT, 3, 'The concept of this book was interesting, but I felt like the execution was a bit lacking. It wasnt a bad read, but it didnt quite live up to my expectations.', '2022-01-06', 6, 2),
  (DEFAULT, 4, 'I really enjoyed the character development in this book. The plot was a bit predictable, but overall it was a satisfying read.', '2022-01-07', 7, 3),
  (DEFAULT, 4, 'This book was incredible! I was hooked from the very first page. The writing was beautiful and the story was so immersive.', '2022-01-08', 8, 4),
  (DEFAULT, 2, 'It was an okay book. I didnt love it, but I didnt hate it either. It was just kind of...meh.', '2022-01-09', 9, 1),
  (DEFAULT, 5, 'I really enjoyed the setting and atmosphere of this book. The plot was a bit slow-moving, but overall it was a good read.', '2022-01-10', 10, 2);

INSERT INTO photo VALUES (DEFAULT, 'avatar1.jpg', NULL, 1);
INSERT INTO photo VALUES (DEFAULT, 'avatar2.jpg', NULL, 2);
INSERT INTO photo VALUES (DEFAULT, 'avatar3.jpg', NULL, 3);
...
INSERT INTO photo VALUES (DEFAULT, 'The Brothers Karamazov.jpg', 11);
INSERT INTO photo VALUES (DEFAULT, 'The Old Man and the Sea.jpg', 12);
